class Params { 
    ...
    class btc_p_en { // Enemy type: [Guide to add more in docs]
        ...
        texts[]={"0 - Bohemia Interactive: CSAT (Side: EAST)","1 - Bohemia Interactive: FIA (Side: EAST)","2 - CUP Community Upgrade Project: Armed Forces of the Russian Federation (Side: EAST)","3 - CUP Community Upgrade Project: Chernarussian Movement of the Red Star (Side: EAST)","4 - CUP Community Upgrade Project: Sahrani Liberation Army (Side: EAST)","5 - CUP Community Upgrade Project: Takistani Army (Side: EAST)","6 - CUP Community Upgrade Project: Takistani Militia (Side: EAST)","7 - CUP_Units Community Upgrade Project: Armed Forces of the Russian Federation (Modern) (Side: EAST)","8 - Enoch Bohemia Interactive: Spetsnaz (Side: EAST)","9 - Expansion Bohemia Interactive: Gendarmerie (Side: EAST)","10 - FIR Firewill: AWS - RED SIDE (Side: EAST)","11 - OPF Community Upgrade Project: CSAT (Pacific) (Side: EAST)","12 - RHS Red Hammer Studios: Russia (VMF) (Side: EAST)","13 - RHS_AFRF Red Hammer Studios: Russia (MSV) (Side: EAST)","14 - RHS_AFRF Red Hammer Studios: Russia (RVA) (Side: EAST)","15 - RHS_AFRF Red Hammer Studios: Russia (TV) (Side: EAST)","16 - RHS_AFRF Red Hammer Studios: Russia (VDV) (Side: EAST)","17 - RHS_AFRF Red Hammer Studios: Russia (VPVO) (Side: EAST)","18 - RHS_AFRF Red Hammer Studios: Russia (VV) (Side: EAST)","19 - RHS_AFRF Red Hammer Studios: Russia (VVS - Camo) (Side: EAST)","20 - RHS_AFRF Red Hammer Studios: Russia (VVS - Grey) (Side: EAST)"};
        default = 5;
    };
