...
btc_everything = _cGround_vehicles, _cAir_vehicles, _cFortifications, _cStatics, _cAmmobox, _cContainers, _cSupplies, _cFOB, _cVehicle_logistic;
...
_alltoprice = flatten btc_everything + flatten btc_type_boats + flatten btc_type_motorized + flatten btc_type_motorized_armed; 
_alltopricearray = []; 
ALLTOPRICETOTAL = [];
