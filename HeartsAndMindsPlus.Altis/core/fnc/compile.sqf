...
tet_fortify_fill = compileScript ["core\fnc\fortify\fill.sqf"];
tet_fortify_progress = compileScript ["core\fnc\fortify\progress.sqf"];
...
tet_perms = compileScript ["core\fnc\ui\tetperms.sqf"];
