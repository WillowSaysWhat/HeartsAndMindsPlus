...
//ADDNOTIF OBJ CLEAR
[parseText "<t color='#FACE00' font='PuristaBold' align = 'right' shadow = '1.5' size='2'>+ Objective Cleared! </t><br /><t  align = 'right' shadow = '1.5' size='1.5'>+$300</t>", [0, 0.5, 1, 1], nil, 5, 1.7, 0] remoteExec ["BIS_fnc_textTiles", 0];
